    ...
    public void startCapturing(final PictureCapturingListener listener) {
        ...
        try {
            ...
            if (cameraIds.length > 0) {
                this.cameraIds.add(cameraIds[1]); //front camera only
...
//works!
    ...
    /**
     * Much thanks to Android Team (https://stackoverflow.com/questions/49746742/unable-to-store-image-to-internal-storage)
     * @param bitmapImage image in bitmap format
    ...
    private String saveToInternalStorage(Bitmap bitmapImage){
        ...
        // Create imageDir
        @SuppressLint("SimpleDateFormat") String fileName = new SimpleDateFormat("yyyyMMddHHmmss'.png'").format(new Date());
